About nomad-camels-driver-cam-control-pylablib-feedstock
========================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/nomad-camels-driver-cam-control-pylablib-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nomad-camels-driver-cam-control-pylablib-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nomad-camels-driver-cam-control-pylablib
# for installing globally
pixi global install nomad-camels-driver-cam-control-pylablib
```
...
It is possible to list all of the versions of `nomad-camels-driver-cam-control-pylablib` available on your platform:
...
```
pixi search nomad-camels-driver-cam-control-pylablib --channel conda-forge
```
